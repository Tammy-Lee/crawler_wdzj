...
def parse_return_rate_diff(datas):
    ...
    return _parse(datas['data1'], ['x', 'y1', 'y2', 'y3', 'y4', 'y5'], new_keys)
...
def parse_complete_time_diff(datas):
    ...
    return _parse(datas['data1'], ['x', 'y6', 'y7', 'y8', 'y9', 'y10'], new_keys)
